...
class AuthController extends Controller
{
    ...
    public function login(LoginRequest $request) {
        ...
        if($do){
            ...
            return response()->json(['success' => false, 'message' => 'username or password is invalid'], 401);
        }
    ...
    public function register(RegisterRequest $request){
        ...
        if(Auth::check()) return abort(500, 'User with active session');
        ...
        if($user){
            ...
            return response()->json(['success' => true, 'message' => 'Account created successfully!', 'data' => $user], 200);
        }

        return response()->json(['success' => false, 'message' => 'Error creating account.'], 500);
    }
