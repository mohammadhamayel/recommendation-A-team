                ...
                <div class="col-lg-8 bg-white my-1">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-12">
                            ...
                            <p>Fill in the fields below to complete your subscription!</p>
                        </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <div class="form-checkout">
                                ...
                                <input type="text" id="card-holder-name" name="card-name" value="{{ auth()->user()->name . ' ' .auth()->user()->lastname }}" placeholder="Cardholder" required>
                        ...
                        <div class="col-md-6 mt-3 mt-md-0">
                            ...
                            @if (auth()->user()->activePlan() != false && auth()->user()->activePlan()->details->value != 0)
                                <div class="alert alert-danger">
                                    <p><strong>Attention!</strong><br>Do you have an active plan?</p>
                                    <ul class="mb-1">
                                        <li>Flat <strong>{{ auth()->user()->activePlan()->details->title }}</strong>
                                            <ol>
                                                <li><strong>Start:</strong> {{auth()->user()->activePlan()->start->format('d/m/Y H:i') }}</li>
                                                <li><strong>End:</strong> {{auth()->user()->activePlan()->end->format('d/m/Y H:i') }}</li>
                                            </ol>
                                        </li>
                                    </ul>
                                    <p>
                                        By continuing with this transaction, you will forfeit the remaining time of
                                        <span>
                                            <strong>
                                                {{ now()->diffforHumans(auth()->user()->activePlan()->end, \Carbon\CarbonInterface::DIFF_ABSOLUTE)}}
                                            </strong>
                                        </span>
                                        of your current plan and the new plan will come into effect.</p>
                                </div>
                            @endif
                            <div class="text-center">
                                <h2>Secure transaction!</h2>
                                <span>Your card details will not be saved on our platform.</span>
                            </div>
